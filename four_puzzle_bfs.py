...
if __name__ == "__main__":
    ...
    print("Uso de memoria disponible:", memoria.available)
    print("Porcentaje de memoria utilizada:", memoria.percent)
    print("Uso de memoria en uso:", memoria.used)
    print("Uso de memoria libre:", memoria.free)
